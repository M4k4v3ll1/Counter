...
import {increaseCounterAC, initialStateType} from "./state/reducers/changeValueReducer";
...
//from new Counter
// function App() {
//     const [isOneDisplayVersion, toggleVersion] = useState(true)
//     const changeCounterVersionHandler = () => {
//         toggleVersion(!isOneDisplayVersion)
//     }
//     return (
//         <div className="App">
//             <div className="header">
//                 <h1>Advanced counter</h1>
//                 <SuperButton
//                     name={isOneDisplayVersion ? 'Set two displays' : 'Set single display'}
//                     callback={changeCounterVersionHandler}
//                     isDisabled={false}
//                 />
//             </div>
//             <div className="App">
